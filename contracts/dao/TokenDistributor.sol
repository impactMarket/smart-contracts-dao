...
// * @author - zk@WolfDefi
// * @notice - Provided an EIP712 compliant signed message & token claim, distributes IPCT tokens
// **/
//
///**
//* @notice interface for interacting with IPCTToken delegate function
//*/
//interface IPCTErc20 {
...
//    bytes32 constant IPCT_TOKEN_CLAIM_TYPEHASH = keccak256(
...
//         IPCTErc20  IPCTToken = IPCTErc20(token);
//         IPCTToken.delegateOnDist(delegator, delegatee);
//    }
//}
