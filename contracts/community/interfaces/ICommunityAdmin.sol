...
interface ICommunityAdmin {
    ...
    function communityFactory() external view returns(ICommunityFactory);
    ...
    function addCommunity(address firstManager, uint256 claimAmount, uint256 maxClaim, uint256 baseInterval, uint256 incrementInterval) external;
    function migrateCommunity(address firstManager, ICommunity previousCommunity, ICommunityFactory newCommunityFactory) external;
    function removeCommunity(ICommunity community) external;
    function setCommunityFactory(ICommunityFactory communityFactory) external;
    function initCommunityFactory(ICommunityFactory communityFactory) external;
