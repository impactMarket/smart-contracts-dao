...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  let cUSDToken = chainID === "44787" ? "0x874069fa1eb16d44d622f2e0ca25eea172369bc1" 
    : chainID === "62320" ? "0x62492a644a588fd904270bed06ad52b9abfea1ae" 
      : chainID === "42220" ? "0x765de816845861e75a25fca122bb6898b8b1282a" 
        : ZERO_ADDRESS;
