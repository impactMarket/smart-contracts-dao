...
// 				.managerJoinFromMigrated()
// 		).to.be.rejectedWith("Community::managerJoinFromMigrated: NOT_ALLOWED");
// 		await expect(
// 			newCommunityInstance
...
// 			oneMinuteInBlocks.toString()
// 		);
// 		await communityAdminProxy.updateCommunityBeneficiaryParams(
// 			communityInstance.address,
// 			claimAmountTwo.toString(),
// 			maxClaimTen.toString(),
// 			oneCent.toString(),
...
// 		await expect(
// 			communityAdminProxy.updateCommunityBeneficiaryParams(
// 				communityInstance.address,
// 				claimAmountTwo.toString(),
// 				maxClaimTen.toString(),
// 				oneCent.toString(),
...
// 			communityAdminProxy
// 				.connect(communityManagerA)
// 				.updateCommunityTrancheLimits(parseEther("50"), parseEther("100"))
// 		).to.be.rejectedWith("Ownable: caller is not the owner");
// 	});
//
...
// 			communityAdminProxy
// 				.connect(adminAccount1)
// 				.updateCommunityTrancheLimits(parseEther("100"), parseEther("50"))
// 		).to.be.rejectedWith(
